/*
 * ElectroSolverExplicit.hpp
 *
 *  Created on: Oct 19, 2017
 *      Author: srossi
 */

#ifndef SRC_ELECTROPHYSIOLOGY_ELECTROSOLVER_EXPLICIT_HPP_
#define SRC_ELECTROPHYSIOLOGY_ELECTROSOLVER_EXPLICIT_HPP_
...
enum class AnisotropyExplicit { Isotropic,
                        TransverselyIsotropic,
                        Orthotropic,
                        UserDefined };

enum class EquationTypeExplicit { ReactionDiffusion,
                          Wave,
...
class ElectroSolverExplicit
{
public:
    typedef FactoryArg<ElectroSolverExplicit, std::string, libMesh::EquationSystems >     ElectroFactory;
...
//    std::unique_ptr<IonicModel> M_ionicModelPtr;
    ...
    AnisotropyExplicit M_anisotropy;
    std::vector<double>  M_conductivity;
    EquationTypeExplicit M_equationType;
    DynamicTimeIntegratorType M_timeIntegratorType;
    TimeIntegratorExplicit M_timeIntegrator;
protected:
...
#endif /* SRC_ELECTROPHYSIOLOGY_ELECTROSOLVER_EXPLICIT_HPP_ */
